      ...
      <div className={styles.containerInputOfForm}>
        ...
        <div className={styles.containerInputOfForm__group}>
          ...
          <IoIosWarning
            className={
              checkValidate
                ? styles.containerInputOfForm__group__Icon__isSeleted
                : styles.containerInputOfForm__group__Icon
            }
          />
          {/* Text input field */}
          <InputText
            className={
              checkValidate
                ? styles.containerInputOfForm__group__inputText
                : styles.containerInputOfForm__group__inputText__isSeleted
            }
            type="text"
            name={name}
            value={value}
