...
function InputTextArea({name,label,value,placeholder,handleChange,check}){
    ...
    return (
        <>
         ...
         <div className={styles.containerInputOfForm}>
            ...
            {/* Text input field */}
            <InputTextarea className={checkValidate ? styles.containerInputOfForm__inputTextArea : styles.containerInputOfForm__inputTextArea__isSeleted} type="text" name={name} value={value}  onChange={handleChange} placeholder={placeholder}  onInput={handleValidate} maxLength={100}/>
            {/* Error message*/}
