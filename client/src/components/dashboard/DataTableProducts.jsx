        ...
        <div className={styles.containerDataTable}>
          ...
          <div className={styles.containerSearch}>
             ...
             <IoSearchOutline className={styles.groupInputSearch__icon} />
              {/* Search entry */}
              <InputText onInput={ (e)=> setFilters({global:{value:e.target.value, matchMode: FilterMatchMode. CONTAINS}})} placeholder="Buscar" className={styles.groupInputSearch__input}/>
              </div>
          </div>
